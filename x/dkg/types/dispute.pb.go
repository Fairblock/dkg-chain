...
var fileDescriptor_baa9d5f9ea0c003b = []byte{
	...
	,
}
...
func (m *Dispute) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CReal) > 0 {
		i -= len(m.CReal)
		copy(dAtA[i:], m.CReal)
		i = encodeVarintDispute(dAtA, i, uint64(len(m.CReal)))
		i--
		dAtA[i] = 0x5a
	}
	if m.FaulterId != 0 {
		i = encodeVarintDispute(dAtA, i, uint64(m.FaulterId))
		i--
		dAtA[i] = 0x50
	}
	if m.AccuserId != 0 {
		i = encodeVarintDispute(dAtA, i, uint64(m.AccuserId))
		i--
		dAtA[i] = 0x48
	}
	if m.Id != 0 {
...
func (m *Dispute) Size() (n int) {
	...
	if m.AccuserId != 0 {
		n += 1 + sovDispute(uint64(m.AccuserId))
	}
	if m.FaulterId != 0 {
		n += 1 + sovDispute(uint64(m.FaulterId))
	}
	l = len(m.CReal)
	if l > 0 {
		n += 1 + l + sovDispute(uint64(l))
...
func (m *Dispute) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AccuserId", wireType)
			}
			m.AccuserId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AccuserId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FaulterId", wireType)
			}
			m.FaulterId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FaulterId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CReal", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CReal = append(m.CReal[:0], dAtA[iNdEx:postIndex]...)
			if m.CReal == nil {
				m.CReal = []byte{}
			}
			iNdEx = postIndex
